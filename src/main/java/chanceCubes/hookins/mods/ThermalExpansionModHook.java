...
public class ThermalExpansionModHook extends BaseModHook {
    ...
    public void loadRewards() {
        ...
        if (GameRegistry.findItem(super.modId, "florb") != null) {
            ChanceCubeRegistry.INSTANCE.registerReward(
                new BasicReward(
                    this.modId + ":florbs",
                    60,
                    new MessageRewardType(new MessagePart("Florbs!!")),
                    new ItemRewardType(new ItemPart(GameRegistry.findItemStack(super.modId, "florb", 2))) {
                        ...
                        public void trigger(ItemPart s, World world, int x, int y, int z, EntityPlayer player) {
                            ...
                            for (int i = 0; i < 5; i++) {
                                ...
                                nbt.setString(
                                    "Fluid",
                                    ChanceCubeRegistry.getRandomFluid()
                                        .getName());
        ...
        if (GameRegistry.findItem(super.modId, "pump") != null) {
            ...
            ChanceCubeRegistry.INSTANCE.registerReward(
                new BasicReward(
                    this.modId + ":flui-vac",
                    60,
                    new MessageRewardType(new MessagePart("Well this sucks.....")),
                    new ItemRewardType(new ItemPart(stack))));
        }

        if (GameRegistry.findItem(super.modId, "igniter") != null
            && GameRegistry.findItem(super.modId, "chiller") != null) {
            ...
            ChanceCubeRegistry.INSTANCE.registerReward(
                new BasicReward(
                    this.modId + ":Flux_Chill&Ignite",
                    30,
                    new MessageRewardType(new MessagePart("Fire and Ice")),
                    new ItemRewardType(new ItemPart(stack), new ItemPart(stack2))));
        }
        ...
        if (GameRegistry.findItem(super.modId, "capacitor") != null) {
            ...
            ChanceCubeRegistry.INSTANCE.registerReward(
                new BasicReward(
                    this.modId + ":Tuberous_Capacitor",
                    25,
                    new MessageRewardType(new MessagePart("It's a potato!!")),
                    new ItemRewardType(new ItemPart(stack))));
        }
    }
}
