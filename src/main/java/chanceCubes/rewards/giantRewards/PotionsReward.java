...
public class PotionsReward implements IChanceCubeReward {
    ...
    private int[] metas = new int[] { 16385, 16450, 16419, 16420, 16452, 16453, 16422, 16424, 16393, 16426, 16428,
        16460, 16461, 16430 };
    ...
    private void throwPoitonCircle(final int itteration, final World world, final int x, final int y, final int z,
        final EntityPlayer player) {
        for (double rad = -Math.PI; rad <= Math.PI; rad += (Math.PI / 20)) {
            pot = new EntityPotion(
                world,
                player,
                new ItemStack(Items.potionitem, 1, metas[rand.nextInt(metas.length)]));
    ...
    private void throwPoiton(final int itteration, final World world, final int x, final int y, final int z,
        final EntityPlayer player) {
