...
public class ItemOfDestinyReward implements IChanceCubeReward {
    ...
    private void changeEnchants(final EntityItem item, final int enchants, final int iteration,
            ...
            public void callback() {
                if (iteration < enchants) {
                    ...
                    player.addChatMessage(
                        new ChatComponentText(ench.getTranslatedName(level) + " Has been added to the item!"));
    ...
    public Item randomItem() {
        ...
        while (item == null) item = Item.getItemById(256 + rand.nextInt(166));
        return item;
    }
    ...
    public Enchantment randomEnchantment() {
        ...
        while (ench == null) ench = Enchantment.enchantmentsList[rand.nextInt(Enchantment.enchantmentsList.length)];
        return ench;
    }
