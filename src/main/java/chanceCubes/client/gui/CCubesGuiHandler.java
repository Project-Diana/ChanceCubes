        ...
        switch (ID) {
            case CREATIVE_PENDANT_ID:
                if (player.inventory.getCurrentItem() != null && player.inventory.getCurrentItem()
                    .getItem()
                    .equals(CCubesItems.creativePendant)) return new CreativePendantGui(player, world);
                break;
            default:
                return null;
        }
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        switch (ID) {
            case CREATIVE_PENDANT_ID:
                if (player.inventory.getCurrentItem() != null && player.inventory.getCurrentItem()
                    .getItem()
                    .equals(CCubesItems.creativePendant)) return new CreativePendantContainer(player.inventory, world);
                break;
            default:
                return null;
        }
